...
def save_table_as_image(df, output_file):
    ...
    plt.title("Ringkasan Hasil Tes Semua VUs", fontsize=12, pad=20)
    plt.savefig(output_file, bbox_inches="tight", dpi=200)
    plt.close()

def main():
    folder = Path("systematic-results-server")
    ...
    save_table_as_image(df, output_dir / "summary_all_vus_server.png")

    print(f"✅ Tabel ringkasan semua hasil sudah disimpan di: {output_dir/'summary_all_vus.png'}")
